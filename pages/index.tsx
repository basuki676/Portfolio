...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Muhamad Basuki Raharjo',", type: 'array-item' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Muhamad <span className={styles.accentText}>Basuki</span>Raharjo
          </h1>

          <div className={styles.developerRole}>Frontend Developer</div>

          <p className={styles.bio}>
          Crafting intuitive, performant UIs with modern frontend tools like React, Next.js, and Tailwind CSS.
          </p>
